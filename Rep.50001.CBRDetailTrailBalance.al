report 50001 "CBR Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CBRDetailTrialBalance.rdl';
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem("G/L Entry"; "G/L Entry")
                {
                    ...
                    column(PuchaseInvoiceDesc; PuchaseInvoiceDesc)
                    {
                    ...
                    begin
                        ...
                        PuchaseInvoiceDesc := UpdatePurchaseInvoiceDesc("Document No.", "Debit Amount");
                    end;
    ...
    procedure UpdatePurchaseInvoiceDesc(DocumnetNo: Code[20]; DbtAmount: Decimal): Text[150]
    var
    begin
